...
with open("datos.html", "w") as file:
    file.write('<!DOCTYPE html><html><head><link type="text/css" rel="stylesheet" href="static/bootstrap/css/custom.css" media="all"></head><body>')
...
for i in xrange (0,filas): # i = columnas
    for j in xrange (0,columnas): # j = filas
        ...
        with open("datos.html", "a") as file:
            file.write('<div class="tooltip" style=" border: none; position: absolute; width: 100px; height: 100px; left: {1}px; top:{0}px;"><span class="tooltiptext">{2}</span></div>'.format(i*100+58,j*100+62,temp[i][j]))
with open("datos.html", "a") as file:
